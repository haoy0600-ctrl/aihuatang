...
export const HANDDRAWN_STYLES: HanddrawnStyle[] = [
  ...
  },
  {
    ...
    purpose: '机械美学复古未来',
    styleKeywords:
      'Steampunk machinery, brass gears, Victorian engineering, retro-futurism, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, industrial nostalgia, mechanical complexity',
  ...
  },
  {
    ...
    purpose: '昭和年代怀旧氛围',
    styleKeywords:
      'Taisho romantic style, Japanese retro, nostalgic atmosphere, vintage elegance, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, sketchbook aesthetic, Meiji-Taisho era charm, cherry blossom motifs',
  ...
  },
  {
    ...
    purpose: '课堂教学知识讲解',
    styleKeywords:
      'Chalkboard drawing, black background white chalk, handwritten text, academic lecture feel, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, university classroom atmosphere, authentic chalk texture',
  ...
  },
  {
    ...
    purpose: '思维梳理知识架构',
    styleKeywords:
      'Whiteboard marker, colorful diagrams, mind map structure, brainstorming session, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, sketchbook aesthetic, collaborative workspace, vibrant markers',
  ...
  },
  {
    ...
    purpose: '商业分析战略规划',
    styleKeywords:
      'Consulting presentation, professional charts, clean infographics, corporate strategy, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, executive presentation quality, data-driven design',
  ...
  },
  {
    ...
    purpose: '教材插图知识图解',
    styleKeywords:
      'Textbook illustration, engraved line art, scientific accuracy, educational excellence, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, scholarly publication, detailed technical drawings',
  ...
  },
  {
    ...
    purpose: '儿童教育启蒙认知',
    styleKeywords:
      "Children's doodle art, simple shapes, colorful crayon strokes, innocent creativity, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, sketchbook aesthetic, playful learning, childlike wonder",
  ...
  },
  {
    ...
    purpose: '科学探索创意草图',
    styleKeywords:
      'Da Vinci manuscript, anatomical sketches, mechanical drawings, Renaissance genius, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, sketchbook aesthetic, scientific curiosity, master draftsman quality',
  ...
  },
  {
    ...
    purpose: '医学教育人体结构',
    styleKeywords:
      'Medical anatomy, precise pencil drawing, scientific illustration, anatomical accuracy, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, medical textbook quality, detailed biological art',
  ...
  },
  {
    ...
    purpose: '地理探索自然考察',
    styleKeywords:
      'Hand-drawn map, terrain illustrations, field journal, exploration adventure, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, sketchbook aesthetic, cartographic art, vintage exploration',
  ...
  },
  {
    ...
    purpose: '考试复习知识体系',
    styleKeywords:
      'Study notes, structured framework, hierarchical diagrams, exam preparation, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, academic excellence, systematic learning',
  ...
  },
  {
    ...
    purpose: '复古游戏知识可视化',
    styleKeywords:
      'Pixel art, 8-bit graphics, retro gaming aesthetic, pixel-perfect design, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, nostalgic gaming, digital retro art',
  ...
  },
  {
    ...
    purpose: '科幻未来科技感',
    styleKeywords:
      'Cyberpunk neon, glowing wireframes, dark backgrounds, holographic elements, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, futuristic dystopia, Blade Runner aesthetic',
  ...
  },
  {
    ...
    purpose: '几何抽象科技感',
    styleKeywords:
      'Low poly art, geometric shapes, faceted surfaces, vibrant colors, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, abstract modernity, digital geometry',
  ...
  },
  {
    ...
    purpose: '活力多彩年轻时尚',
    styleKeywords:
      'Fluid gradients, vibrant colors, abstract shapes, dynamic flow, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, youthful energy, Instagram-worthy design',
  ...
  },
  {
    ...
    purpose: '反传统创意表达',
    styleKeywords:
      'New ugly style, chaotic collage, conflicting elements, experimental design, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, avant-garde expression, rule-breaking aesthetics',
  ...
  },
  {
    ...
    purpose: '艺术表达多角度思考',
    styleKeywords:
      'Cubism, geometric abstraction, fragmented forms, multi-perspective, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, Picasso-inspired, intellectual art',
  ...
  },
  {
    ...
    purpose: '速度与科技感',
    styleKeywords:
      'Futurist speed lines, motion blur, dynamic composition, streamlined design, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, cinema-grade contrast, technological advancement, kinetic energy',
  ...
  },
  {
    ...
    purpose: '温柔治愈舒缓情绪',
    styleKeywords:
      'Morandi color palette, muted tones, soft harmony, gentle atmosphere, 8K resolution, Hasselblad H6D medium format rendering, 85mm fixed-focus lens effects, sketchbook aesthetic, calming colors, peaceful composition, poetic minimalism',
