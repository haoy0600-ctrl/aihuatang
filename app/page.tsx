  ...
  return (
    <div className="min-h-screen w-full bg-[#030712] text-white flex flex-col relative overflow-hidden">
      ...
      <header className="flex-shrink-0 border-b border-[#1e293b]/50 sticky top-0 z-[60] bg-[#030712]/95 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="header-glow-particles"></div>
      ...
      <main className="flex-1 flex flex-col items-center px-3 py-4 sm:py-6 relative z-10 pt-4 pb-8">
        <div ref={heroRef} className="text-center mb-6 sm:mb-8">
          ...
          <p className={`text-xs sm:text-sm text-gray-400 max-w-2xl mx-auto mb-3 sm:mb-4 leading-relaxed ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`} style={{animationDelay: '0.3s'}}>
            告别生硬AI感，拒绝繁琐排版。内置智能排版引擎，一句话秒级重构为高密度爆款知识卡片。
          </p>
          <p className={`text-xs sm:text-sm text-[#03F09C]/80 max-w-2xl mx-auto mb-3 sm:mb-4 leading-relaxed ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`} style={{animationDelay: '0.5s'}}>
            【全新升级】AI画堂采用行业顶尖的高级 Image 模型一键超清生成技术！标准画质仅需 2 积分；升级 2K 超清生成仅需 4 积分；至臻 4K 分辨率（专为小红书/抖音自媒体爆款图形设计定制）超值回馈，现仅需 8 积分即可一键脑补细节、解锁商业级超清视界！
          </p>
          <Link
            href="/dashboard"
            ...
            <div className="md:col-span-2 bg-[#0f172a] border border-red-900/30 rounded-xl p-3 sm:p-4">
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <div className="flex items-start gap-1.5">
                  ...
                  <div>
                    <p className="text-xs text-red-300 font-semibold">成本偏高</p>
                    <p className="text-xs text-red-400/70">主流平台单张约 0.5-1 元。</p>
                  </div>
                </div>
                <div className="flex items-start gap-1.5">
                  <span className="text-red-500 text-xs mt-0.5">❌</span>
                  <div>
                    <p className="text-xs text-red-300 font-semibold">风格单一</p>
                    <p className="text-xs text-red-400/70">模板化严重，缺乏个性。</p>
                  </div>
                </div>
                <div className="flex items-start gap-1.5">
                  <span className="text-red-500 text-xs mt-0.5">❌</span>
                  <div>
                    <p className="text-xs text-red-300 font-semibold">响应较慢</p>
                    <p className="text-xs text-red-400/70">高峰期排队，等待时间长。</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="md:col-span-2 bg-[#0f172a] border border-[#10B981]/30 rounded-xl p-3 sm:p-4">
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <div className="flex items-start gap-1.5">
                  ...
                  <div>
                    <p className="text-xs text-[#10B981] font-semibold">高性价比</p>
                    <p className="text-xs text-[#10B981]/70">1K高清2点/张，多档位灵活选择。</p>
                  </div>
                </div>
                <div className="flex items-start gap-1.5">
                  <span className="text-[#10B981] text-xs mt-0.5">✅</span>
                  <div>
                    <p className="text-xs text-[#10B981] font-semibold">风格多样</p>
                    <p className="text-xs text-[#10B981]/70">50+种美术风格，支持自定义。</p>
                  </div>
                </div>
                <div className="flex items-start gap-1.5">
                  <span className="text-[#10B981] text-xs mt-0.5">✅</span>
                  <div>
                    <p className="text-xs text-[#10B981] font-semibold">极速响应</p>
                    <p className="text-xs text-[#10B981]/70">专属节点，秒级生成。</p>
                  </div>
                </div>
              </div>
            </div>
